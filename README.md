            ...
            <center><div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 section display:none;">
                        <img src="https://th.bing.com/th/id/OIP.yY9X3U95HUJZuBRgUATStAAAAA?w=240&h=240&rs=1&pid=ImgDetMain" alt="Love Letter" onclick="redirectTo('#')">
                        <p>Love Letter</p>
                    </div>
                    <!-- Placeholder Section 4 -->
                    <div class="col-md-4 section">
                        <img src="https://th.bing.com/th/id/OIP.yY9X3U95HUJZuBRgUATStAAAAA?w=240&h=240&rs=1&pid=ImgDetMain" alt="Placeholder 4" onclick="redirectTo('#')">
                        <p>Sorry Letter</p>
                    </div>
                    ...
                    <div class="col-md-4 section">
                        <img src="https://th.bing.com/th/id/OIP.yY9X3U95HUJZuBRgUATStAAAAA?w=240&h=240&rs=1&pid=ImgDetMain" alt="Placeholder 6" onclick="redirectTo('#')">
                        <p>Essay Writer</p>
                    </div>
                    <!-- Placeholder Section 7 -->
                    <div class="col-md-4 section">
                        <img src="https://th.bing.com/th/id/OIP.yY9X3U95HUJZuBRgUATStAAAAA?w=240&h=240&rs=1&pid=ImgDetMain" alt="Placeholder 7" onclick="redirectTo('#')">
                    ...
                    <div class="col-md-4 section">
                        <img src="https://th.bing.com/th/id/OIP.yY9X3U95HUJZuBRgUATStAAAAA?w=240&h=240&rs=1&pid=ImgDetMain" alt="Placeholder 9" onclick="redirectTo('#')">
                        <p>Upload Videos</p>
                    </div>
                    <!-- Placeholder Section 10 -->
                    <div class="col-md-4 section">
                        <img src="https://th.bing.com/th/id/OIP.yY9X3U95HUJZuBRgUATStAAAAA?w=240&h=240&rs=1&pid=ImgDetMain" alt="Placeholder 10" onclick="redirectTo('#')">
                        <p>Upload Pdfs</p>
                    </div>
                </div>
            </div>
